...
import com.nathit.mallshoppingonline.CategoryActivity;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setCategoryIcon(String iconUri) {
            if (!iconUri.equals("null")) {
                Glide.with(itemView.getContext()).load(iconUri).apply(new RequestOptions().placeholder(R.drawable.ic_home)).into(categoryIcon);
            } else {
